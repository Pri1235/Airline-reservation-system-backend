...
public interface FlightRepo extends JpaRepository<Flight,Integer> {
    ...
    @Query("SELECT new com.example.demo.dto.FlightDTO(f.flight_id,f.flight_name, f.flight_number, f.airline_id.airline_id, f.aircraft_id.aircraft_id) "
    ...
    @Query("SELECT new com.example.demo.dto.FlightDTO(f.flight_id,f.flight_name, f.flight_number, f.airline_id.airline_id, f.aircraft_id.aircraft_id) "
            + "FROM Flight f WHERE f.airline_id.airline_id = :airlineId ORDER BY f.flight_id")
